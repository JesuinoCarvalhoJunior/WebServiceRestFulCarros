...
// O @Path foi definido como ("/carros"),
// o endereco ficara = http://localhost:8080/WebServiceRestFulCarros/rest/carros

//@Consumes - define o tipo de conteudo que o metodo consome - neste caso JSON
//@Produces - define o tipo de conteudo que o metodo retorna - neste caso JSON
